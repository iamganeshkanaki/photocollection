...
const Home = () => {
    function toggleMenu() {
        document.querySelector('.sidebar').style.width = document.querySelector('.sidebar').style.width === '250px' ? '0' : '250px';
    }
        ...
        <div>
            <header>
                ...
                <nav className='topnav' id='myTopnav'>
                    ...
                    <Link to={`/gallery`}><span>Photos </span></Link>
            ...
            <section className="abo" id='mainAbout'>
                <h2>About Us: </h2>
